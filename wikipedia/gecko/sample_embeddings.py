...
def main(project_name, location, source, batch_size, start_index, end_index):
    ...
    names = os.listdir(os.path.join(os.path.dirname(__file__), "../../data/samples_wikipedia"))
    ...
    for name in tqdm(names):
        ckpt = torch.load(os.path.join(os.path.dirname(__file__), "../../data/samples_wikipedia", f"{name}.pt"))
