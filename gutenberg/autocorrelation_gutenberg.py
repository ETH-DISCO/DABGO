...
def compute_blockwise_autocorrelation(gradient_files, eps=1e-12, device='cpu', start_index=0):
    ...
    torch.save(block_autocorr_inv_sqrt, os.path.join(gradient_dir, f"autocorr_matrices_inv_sqrt.pt"))
